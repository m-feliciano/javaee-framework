...
//    @BeforeEach
//    void setUp() {
//        try (var propertiesUtilMock = mockStatic(Properties.class)) {
//            propertiesUtilMock
//                    .when(() -> Properties.getOrDefault(eq("rate.limit.capacity"), any()))
//                    .thenReturn(10L);
//            propertiesUtilMock
//                    .when(() -> Properties.getOrDefault(eq("rate.limit.refill.tokens"), any()))
//                    .thenReturn(10L);
//            propertiesUtilMock
//                    .when(() -> Properties.getOrDefault(eq("rate.limit.refill.period.seconds"), any()))
//                    .thenReturn(60L);
//
