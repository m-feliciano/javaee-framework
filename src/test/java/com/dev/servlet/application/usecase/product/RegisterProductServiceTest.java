...
class RegisterProductServiceTest {
    ...
    class SuccessfulRegistrationTests {
        ...
        void shouldRegisterProductSuccessfully() {
            // Act
            ProductResponse response = registerProductService.register(productRequest, AUTH_TOKEN);
        ...
        void shouldSetRegisterDate() {
            ...
            // Act
            registerProductService.register(productRequest, AUTH_TOKEN);
    ...
    class ProductDataValidationTests {
        ...
        void shouldHandleProductWithAllFields() {
            ...
            // Act
            ProductResponse response = registerProductService.register(fullRequest, AUTH_TOKEN);
        ...
        void shouldHandleProductWithMinimalFields() {
            ...
            // Act
            ProductResponse response = registerProductService.register(minimalRequest, AUTH_TOKEN);
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleLongProductName() {
            ...
            // Act
            ProductResponse response = registerProductService.register(request, AUTH_TOKEN);
