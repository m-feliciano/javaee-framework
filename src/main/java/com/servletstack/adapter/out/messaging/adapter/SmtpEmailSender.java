package com.servletstack.adapter.out.messaging.adapter;
...
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.changeEmailHtml;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.changeEmailPlain;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.emailConfirmationHtml;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.emailConfirmationPlain;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.subjectChangeEmail;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.subjectEmailConfirmation;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.subjectWelcome;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.welcomeHtml;
import static com.servletstack.adapter.out.messaging.email.EmailTemplates.welcomePlain;
