package com.dev.servlet.infrastructure.messaging.config;

import lombok.extern.slf4j.Slf4j;

import static com.dev.servlet.core.util.Properties.getEnvOrDefault;
...
public class MessageConfig {
    ...
    public static BrokerConfig createBrokerConfig(String name) {
        String brokerUrl = getEnvOrDefault("ACTIVEMQ_BROKER_URL", "tcp://activemq:61616");
        String user = getEnvOrDefault("ARTEMIS_USER", "artemis");
        String pass = getEnvOrDefault("ARTEMIS_PASSWORD", "artemis");
