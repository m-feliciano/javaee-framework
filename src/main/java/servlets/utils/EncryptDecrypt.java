...
public class EncryptDecrypt {
     ...
     */
    @NotNull
    private static Cipher getCipher(String transformation, int decryptMode) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException {
        // Default byte array
