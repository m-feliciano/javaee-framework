...
public final class Base {
    ...
    public static final String REDIRECT_INVENTORY_ACTION_LIST_ITEMS = "redirect:inventory?action=ListItems";
    public static final String REDIRECT_INVENTORY_ACTION_LIST_ITEMS_BY_ID = "redirect:inventory?action=ListItems&id=";
    ...
    public static final String REDIRECT_PRODUCT_ACTION_LIST_PRODUCTS = "redirect:product?action=ListProducts";
    public static final String REDIRECT_PRODUCT_ACTION_LIST_PRODUCTS_BY_ID = "redirect:product?action=ListProducts&id=";
    ...
    public static final String REDIRECT_CATEGORY_ACTION_LIST_CATEGORIES = "redirect:category?action=ListCategories";
    public static final String REDIRECT_CATEGORY_ACTION_LIST_CATEGORY_BY_ID = "redirect:category?action=ListCategory&id=";
    ...
    public static final String REDIRECT_PRODUCT_ACTION_CREATE_USER = "redirect:product?action=CreateUser";
    public static final String REDIRECT_USER_ACTION_LIST_USER_BY_ID = "redirect:user?action=ListUser&id=";
